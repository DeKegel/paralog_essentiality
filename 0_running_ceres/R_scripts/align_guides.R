...
local_dir <- "../../data/processed/depmap19Q1"
...
file_gene_annot <- file.path(third_party_dir, "ccds_gene_annotations", "CCDS.20131129.txt")

# Output
file_alignments <- file.path(local_dir, "guide_alignments_hg19.csv")
...
bowtie_cmd <- paste('bowtie', "-t -a -v 2 -f -S", "hg19", fasta_file, sam_file)
...
genome_info <- GenomeInfoDb::Seqinfo(genome="hg19")[chromosomes]
